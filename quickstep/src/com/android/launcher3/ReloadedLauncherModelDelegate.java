...
public class ReloadedLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "ReloadedLauncherModelDelegate";
    ...
    public ReloadedLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
