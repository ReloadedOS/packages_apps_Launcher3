...
import com.android.launcher3.ReloadedLauncher;
import com.android.launcher3.ReloadedLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        ReloadedLauncher launcher = (ReloadedLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        ReloadedLauncherModelDelegate delegate = (ReloadedLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        ReloadedLauncher launcher = (ReloadedLauncher) ActivityContext.lookupContext(getContext());
